---
title: "Making 'Be Yourself'"
date: "2026-07-13"

layout: ../../layouts/PostLayout.astro
description: "How I built a beat out of Bruce Lee, a wet guitar, and some scratches."
...
This was part of [my challenge](/posts/making-normal-life) to myself this weekend to make [two songs.](/posts?tag=music) This was the second one, built entirely from samples. Every old-school hip-hop producer knows how to chop up vinyl from jazz, soul, and just about anywhere else to create the beats you hear on albums like Nas' [*Illmatic*](https://en.wikipedia.org/wiki/Illmatic).
...
The Bruce Lee clip opens the track. I cleaned it up a little in [FL Studio](https://www.image-line.com/fl-studio/) and let it sit right at the front with almost nothing behind it.

## The Guitar

The wet guitar is the backbone of the whole thing. It runs through the track, chopped a few different ways depending on where you are in the song. I didn't want it to feel like a loop.

## Building the Track

The drums were the weird part. I wanted them to sound like they were coming out of a stereo or a radio. Most producers try to avoid that.
