...
export default function DarkModeUtility() {
  ...
  const handleThemeMode = () => {
    ...
    // Max distance from button to any corner
    ...
    overlay.style.cssText = `
      ...
      background: ${next === "dark" ? "#2a2b39" : "#e8d8c8"};
      z-index: 0;
      pointer-events: none;
  ...
  return (
    <button
      ref={buttonRef}
      className="flex items-center justify-center w-9 h-9 self-center text-secondary dark:text-dk-secondary"
      onClick={handleThemeMode}
      aria-label="Toggle dark mode"
    >
      <span className="dark:hidden">
        <svg className="fill-secondary hover:fill-accent w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40">
      ...
      <span className="hidden dark:inline">
        <svg className="fill-dk-secondary hover:fill-dk-accent w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40">
